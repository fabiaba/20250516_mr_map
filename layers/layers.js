...
lyr_PlannedCases_1.set('fieldLabels', {'Location': 'header label - always visible', 'Country': 'header label - always visible', 'Info': 'header label - always visible', 'Status': 'header label - always visible', 'Housholds': 'header label - always visible', 'Link': 'header label - always visible', 'id': 'hidden field', });
lyr_ImplementedCases_2.set('fieldLabels', {'Location': 'header label - always visible', 'Country': 'header label - always visible', 'Info': 'header label - always visible', 'Status': 'header label - always visible', 'Housholds': 'header label - always visible', 'Link': 'header label - always visible', 'id': 'hidden field', });
